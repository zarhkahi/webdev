  ...
  public function __construct() {
    ...
    protected function generaCamposFormulario ($datos) {
        ...
        <fieldset class="formEvents">
            ...
            <input class="field" type="text" name="EventName" placeholder="Nombre del evento" pattern="$this->TEXTO_REGEXP" value="$defaultName" required/>
            <p>Fecha </p>
            ...
            <p>Descripcion </p>
            <textarea class="field" rows="5" cols="50" name="EventDes" placeholder="Comenta de que trata el evento" required/>$defaultDes</textarea><br />
            <p>Precio(euros) </p>
            <input class="fieldDatePrice" type="number" name="EventPrice" placeholder="Si es gratis mejor" value="$defaultPrice" /><br/>
            <p><label>Imagen</label><br /><input class="field" name="uploadImg" type="file" required /><br /></p>
            <button  class="field" type="submit" name=submit>Crear</button>
        </fieldset>
EOF;
